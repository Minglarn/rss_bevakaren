...
self.addEventListener('push', function(event) {
  ...
  const defaultPngIcon = new URL('/default-feed-icon.png?v=2026.09.18.11', self.location.origin).href;
  const defaultBadge = new URL('/badge.png?v=2026.09.18.11', self.location.origin).href;
